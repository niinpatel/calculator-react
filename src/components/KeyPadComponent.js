...
const KeyPadComponent = ({onClick}) => {
    return (
        <div className="button">
            <button className={`actions`} name="(" onClick={e => onClick(e.target.name)}>(</button>
            <button className={`actions`} name="CE" onClick={e => onClick(e.target.name)}>CE</button>
            <button className={`actions`} name=")" onClick={e => onClick(e.target.name)}>)</button>
            <button className={`actions`} name="C" onClick={e => onClick(e.target.name)}>C</button>
            <br/>
            ...
            <button className={`actions`} name="*" onClick={e => onClick(e.target.name)}>x</button>
            <br/>


            <button name="." onClick={e => onClick(e.target.name)}>.</button>
            <button name="0" onClick={e => onClick(e.target.name)}>0</button>
            <button className={`actions equal`} name="=" onClick={e => onClick(e.target.name)}>=</button>
            <button className={`actions`} name="/" onClick={e => onClick(e.target.name)}>÷</button>
            <br/>
        </div>
    );
